...
export class SampleConfigsRequest extends jspb.Message { 
    ...
    setSampleName(value: string): SampleConfigsRequest;
...
export class SampleConfigsResponse extends jspb.Message { 
    ...
    setIntegrationsList(value: Array<SampleConfigsResponse.Integration>): SampleConfigsResponse;
