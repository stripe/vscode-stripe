...
function prepareParams(
    ...
    if (vmargsCheck !== undefined) {
        ...
        if (agentFlag !== null && (isWorkspaceTrusted === undefined || !isWorkspaceTrusted)) {
            ...
            if (
                ...
                isInWorkspaceFolder(agentFlag, workspace.workspaceFolders)
            ) {
    ...
    if (
        params.indexOf('-noverify') < 0 &&
        params.indexOf('-Xverify:none') < 0 &&
        requirements.java_version < 13
    ) {
